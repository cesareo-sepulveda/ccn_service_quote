...
class ServiceQuoteLine(models.Model):
    ...
    def _ensure_bucket(self, vals):
        """Asegura bucket_id en vals (o devuelve uno) usando quote_id, site_id, service_type y rubro_id."""
    ...
    def create(self, vals_list):
        for vals in vals_list:
            ...
            # Sincronizar campos directos con bucket (si lo acabamos de crear)
